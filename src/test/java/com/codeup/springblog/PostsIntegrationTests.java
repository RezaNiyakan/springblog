...
//                        .containsString("All the posts")));
//        for (Post post : posts) {
//            this.mvc.perform(MockMvcRequestBuilders.get("/posts"))
//                    .andExpect(MockMvcResultMatchers.content().string(Matchers
//                            .containsString(post.getTitle())))
//                    .andExpect(MockMvcResultMatchers.content().string(Matchers
//                            .containsString(post.getBody())));
//        }
//    }
    @Test
...
//    }
    ...
    public void testEditPost() throws Exception {
        // Gets the first post by the testUser for tests purposes
        Post existingPost = postsDao.findAll().get(5);
